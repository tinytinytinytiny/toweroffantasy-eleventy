// @link https://utopia.fyi/type/calculator?c=320,17.5,1.2,1800,19.5,1.333,8,2,&s=0.75|0.5|0.25,1.5|2|3|4|6,s-l|l-2xl|s-xl
...
module.exports = {
	...
	'step-8': 'clamp(4.70rem, calc(3.09rem + 8.05vw), 12.15rem)'
};
