	...
	data() {
		return {
			...
			mimicEffects: [
				{
					affinity: 1200,
					effect: 'When Cobalt-B releases a combo, it restores **50**–**120** points of energy charge at random.'
				},
				{
					affinity: 4000,
					effect: 'When Cobalt-B releases a combo, it restores **90**–**180** points of energy charge at random.'
				}
			],
			recChips: [
				['cobalt-b', 4],
